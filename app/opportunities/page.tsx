        ...
        <div className="space-y-6">
          {OPPORTUNITIES.map((opt, i) => (
            <FadeIn key={opt.id} delay={i * 0.1}>
              <Link href={`/opportunities/${opt.id}`}>
              <div className="group bg-white border border-border rounded-[40px] p-6 md:p-10 md:p-6 md:p-14 hover:border-primary hover:shadow-2xl transition-all duration-700 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 md:p-12 relative overflow-hidden shadow-sm">
                ...
                <div className="flex-1 space-y-8 relative z-10">
                  ...
                  <div className="flex flex-col sm:flex-row gap-6 md:p-12 text-muted font-medium text-lg pt-4 border-t border-zinc-50">
