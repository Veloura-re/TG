    ...
    <div className="bg-white min-h-screen relative overflow-hidden">
      ...
      <section className="section-padding pt-48 pb-32">
        <div className="max-w-6xl">
          ...
          <h1 className="text-7xl md:text-[160px] font-bold tracking-tighter mb-12 leading-[0.8] text-black italic-bold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            ...
            <FadeIn key={i} delay={i * 0.1}>
              <div className="p-12 bg-white border border-border rounded-[60px] hover:border-primary transition-all duration-700 group shadow-sm hover:shadow-2xl">
      ...
      <section className="section-padding py-40">
        <div className="flex flex-col lg:flex-row items-center gap-24">
           ...
           <div className="flex-1 w-full aspect-square bg-black rounded-[80px] p-24 flex flex-col items-center justify-center relative overflow-hidden group shadow-2xl">
              <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 pointer-events-none" />
              <div className="relative z-10 text-center space-y-12">
                 <div className="text-[120px] md:text-[200px] font-bold tracking-tighter leading-none text-white/5 group-hover:text-primary transition-all duration-1000">TR</div>
