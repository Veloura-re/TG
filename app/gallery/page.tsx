  ...
  return (
    <div className="bg-white min-h-screen">
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-10 space-y-10">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((img, i) => (
            <FadeIn key={img} delay={i * 0.1}>
              <div className="break-inside-avoid relative group rounded-[48px] overflow-hidden border border-border hover:border-primary transition-all duration-700 shadow-sm cursor-none">
                <div 
                ...
                >
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500 backdrop-blur-[2px] flex flex-col items-center justify-center p-12 text-center">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none z-[-1]">
        <div className="absolute top-[20%] right-[10%] w-[500px] h-[500px] bg-primary/2 rounded-full blur-[120px]" />
        <div className="absolute bottom-[20%] left-[10%] w-[600px] h-[600px] bg-black/5 rounded-full blur-[150px]" />
      </div>
    </div>
  )
}
