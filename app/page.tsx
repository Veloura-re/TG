...
import { ArrowRight, GraduationCap, Users, Calendar, Award, Sparkles, Zap, Shield } from 'lucide-react'
    ...
    <div className="flex flex-col bg-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-24 pb-32">
        <div className="absolute inset-0 z-0 bg-white">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_0%,rgba(225,29,72,0.05),transparent_70%)]" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary/2 rounded-full blur-[120px]" />
        </div>
        ...
        <div className="section-padding relative z-10 w-full">
          <div className="max-w-5xl mx-auto">
            ...
            <h1 className="text-6xl md:text-[140px] font-bold tracking-tighter mb-12 leading-[0.9] text-black italic-bold">
              <TextReveal text="LEADING" className="mb-2" />
              <TextReveal text="THE" className="mb-2 opacity-30" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-end">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 justify-end">
                <Magnetic>
                  <Link href="/about" className="group bg-black text-white px-10 py-5 rounded-full text-sm font-bold uppercase tracking-widest flex items-center gap-3 hover:bg-primary transition-all shadow-2xl">
                    Discover Path
      ...
      {/* Futuristic Stats */}
      <AnimatedSection className="bg-black text-white py-32 rounded-[60px] mx-6 -mt-32 relative z-20 overflow-hidden shadow-[0_40px_100px_-20px_rgba(0,0,0,0.5)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-16 md:gap-8">
            {[
              ...
              <div key={i} className="flex flex-col items-center md:items-start group">
                <div className="text-8xl md:text-9xl font-bold tracking-tighter mb-4 flex items-start text-primary group-hover:scale-105 transition-transform duration-700">
                  <span className="text-4xl md:text-5xl opacity-40 mt-4 mr-2">{stat.prefix}</span>
                  {stat.value}
                </div>
      ...
      <section className="section-padding py-40">
        <div className="flex flex-col md:row items-end justify-between mb-24 gap-8">
          <div className="max-w-2xl">
            <span className="text-primary font-bold text-xs uppercase tracking-[0.3em] mb-4 block">Intelligence</span>
            <h2 className="text-5xl md:text-8xl font-bold tracking-tighter text-black leading-none">
                ...
                <div className="group cursor-pointer bg-white border border-border p-8 rounded-[40px] hover:border-primary shadow-sm hover:shadow-2xl transition-all duration-500">
                  <div className="aspect-video bg-zinc-100 rounded-3xl mb-10 overflow-hidden relative">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="bg-white/90 backdrop-blur px-3 py-1 rounded-full text-[9px] font-bold uppercase tracking-widest border border-border">Intelligence • Node 0{item}</span>
                    </div>
                  </div>
                  <div className="space-y-6">
                    <h3 className="text-3xl font-bold group-hover:text-primary transition-colors leading-tight tracking-tight">
                      Global Scholarship Initiative Alpha Phase Launched
                    </h3>
                    <p className="text-muted text-lg leading-relaxed line-clamp-2 font-medium">
                      Deploying strategic funding for extreme excellence in high-tech research and sustainable architecture.
                    </p>
                    <div className="pt-4 flex items-center gap-4">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-widest opacity-40 group-hover:opacity-100 transition-opacity">Read protocol</span>
                    </div>
                  </div>
                </div>
              </RevealBox>
